...
# ax2.plot(x, +np.sin(.2*np.pi*x), lw=3.5, c='b', alpha=.7)  # plot something
# ax2.plot(x, +np.cos(.2*np.pi*x), lw=3.5, c='r', alpha=.5)
# ax3.plot(x, -np.sin(.2*np.pi*x), lw=3.5, c='g', alpha=.3)
...
radio = RadioButtons(ax1, ('red', 'blue', 'green'), active=0)
